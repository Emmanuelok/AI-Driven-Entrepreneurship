    ...
    <div className="flex flex-col h-full overflow-y-auto p-4 space-y-5">
      ...
      <Card className="p-4 bg-surface-2/40">
        ...
        <p className="mt-3 text-[10px] text-muted leading-relaxed">
          Add to Claude Desktop, Cursor, or any MCP-aware client via this URL and a token from Settings → MCP tokens. The server speaks the standard JSON-RPC 2.0 over HTTP variant.
        </p>
        <a href="https://modelcontextprotocol.io" target="_blank" rel="noopener" className="mt-2 inline-flex items-center gap-1 text-[10px] uppercase tracking-widest text-muted hover:text-emerald transition">
