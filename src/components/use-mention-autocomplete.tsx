...
// Parent decides where it sits (above / below / floating).
export function MentionDropdown({
  filtered, active, onInsert, className,
}: {
  ...
  return (
    <div className={`z-50 rounded-xl border border-border bg-surface shadow-2xl overflow-hidden ${className ?? ""}`}>
